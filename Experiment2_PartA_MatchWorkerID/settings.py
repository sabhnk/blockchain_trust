...
SESSION_CONFIG_DEFAULTS = dict(
    ...
    mturk_hit_settings={'keywords': 'bonus, study', 'title': 'Experiment 2 Part A (few minutes to complete, bonus for completion)', 'description': 'Receive participation fee and additional bonus for completion.',
                        ...
                        'qualification_requirements': [
                            ...
                            # Experiment 2 Part A Participation: EXCLUDE RETAKERS (TL5)
                            {
                        ...
                        # TL5: Experiment 2 Part A Participation
                        'grant_qualification_id': '3C8RUX4LEUMH0YUAR4L0ES0A7B1M9L'}
)
