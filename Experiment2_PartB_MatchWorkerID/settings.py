...
SESSION_CONFIG_DEFAULTS = dict(
    ...
    mturk_hit_settings={'keywords': 'bonus, study', 'title': 'Experiment 2 Part B (few minutes to complete, bonus for completion)', 'description': 'Receive participation fee and additional bonus for completion.',
                        ...
                        'qualification_requirements': [
                            ...
                            # Experiment 2 Part A Participation: EXCLUDE RETAKERS (TL3)
                            {
                            ...
                            # Experiment 2 Part A Participation: EXCLUDE RETAKERS (TL4)
                            {
                                'QualificationTypeId': "3Q1RN8J3IBIHMTB0MCFMEW5ZN5JM8W",
                                'Comparator': "DoesNotExist",
                                'ActionsGuarded': "DiscoverPreviewAndAccept",
                            },
                            # Experiment 2 Part A Participation: ONLY INCLUDE PARTICIPANTS FROM PART A (TL5)
                            {
                                'QualificationTypeId': "3C8RUX4LEUMH0YUAR4L0ES0A7B1M9L",
                                'Comparator': "Exists",
                                'ActionsGuarded': "DiscoverPreviewAndAccept",
                            },
                        ],
                        # TL5: Experiment 2 Part B Participation
                        'grant_qualification_id': '39QP48ZE6YL8OQHYPXI2RXNNS30E2W'}
)
